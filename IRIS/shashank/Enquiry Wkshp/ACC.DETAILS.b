* @ValidationCode : Mjo3OTA3Mjc0NzpDcDEyNTI6MTQ5NDkzNDUwMzA0Mzpoc2hhc2hhbms6LTE6LTE6MDowOmZhbHNlOk4vQTpERVZfMjAxNzAxLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 May 2017 17:05:03
...
*        RECORDS.FETCHED<-1>= FIELD( STMT.PRINTED.RECORDS, @FM, START, NO.OF.STMT.PRINTED.RECORDS)
*        COUNTER=COUNTER-NO.OF.STMT.PRINTED.RECORDS
